...
import os
GOOGLE_CREDENTIALS_FILE = os.getenv("GOOGLE_CREDENTIALS_FILE")  # Not used in server-side flow
GMAIL_TOKEN_FILE = os.getenv("GMAIL_TOKEN_FILE")  # Not used in server-side flow
