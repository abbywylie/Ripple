...
- **RAG Assistant**: AI-powered networking and recruiting guidance
- **Email Parser**: Smart email thread analysis and interaction logging
- **Networking Tips**: Curated resources from top business schools
- **Meeting Management**: Complete CRUD for meetings
