        ...
        <Button className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/30">
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="first_meeting" className="text-right">
                  First Meeting
                </Label>
                <Input
                  id="first_meeting"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="next_followup" className="text-right">
                  Next Follow-up
                </Label>
                <Input
                  id="next_followup"
          ...
          {editingContact && (
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select value={editingContact.category || 'Professional'} onValueChange={(value) => setEditingContact({...editingContact, category: value})}>
                  <SelectTrigger className="col-span-3">
                    <SelectValue placeholder="Select category" />
                  </SelectTrigger>
                  <SelectContent>
